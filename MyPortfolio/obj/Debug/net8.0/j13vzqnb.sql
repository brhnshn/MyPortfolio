...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260122175442_MyPortfolio', N'8.0.22');
GO
...
ALTER TABLE [SiteSettings] ADD [CopyrightText] nvarchar(200) NULL;
GO

ALTER TABLE [SiteSettings] ADD [DeveloperName] nvarchar(100) NULL;
GO

ALTER TABLE [SiteSettings] ADD [DeveloperUrl] nvarchar(250) NULL;
GO

ALTER TABLE [SiteSettings] ADD [FooterDescription] nvarchar(500) NULL;
GO

ALTER TABLE [SiteSettings] ADD [FooterTitle] nvarchar(100) NULL;
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260124175307_AddTickerAndFooterSettings', N'8.0.22');
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'XUrl');
IF @var43 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var43 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [XUrl] nvarchar(500) NULL;
GO
...
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'Phone');
IF @var44 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var44 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [Phone] nvarchar(30) NULL;
GO
...
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'LogoUrl');
IF @var45 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var45 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [LogoUrl] nvarchar(500) NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'LinkedinUrl');
IF @var46 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var46 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [LinkedinUrl] nvarchar(500) NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'InstagramUrl');
IF @var47 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var47 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [InstagramUrl] nvarchar(500) NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'GithubUrl');
IF @var48 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var48 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [GithubUrl] nvarchar(500) NULL;
GO
...
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'FaviconUrl');
IF @var49 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var49 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [FaviconUrl] nvarchar(500) NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[SiteSettings]') AND [c].[name] = N'DeveloperUrl');
IF @var50 IS NOT NULL EXEC(N'ALTER TABLE [SiteSettings] DROP CONSTRAINT [' + @var50 + '];');
ALTER TABLE [SiteSettings] ALTER COLUMN [DeveloperUrl] nvarchar(500) NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260124182559_IncreaseSiteSettingsUrlLengths', N'8.0.22');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260124192102_AddNavbarItems', N'8.0.22');
GO
